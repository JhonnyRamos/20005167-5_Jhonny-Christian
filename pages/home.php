...
<main>
    ...
    <div class="row">
        <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
            ...
            <h1 class="title display-5 fw-bold">Você é bem-vindo aqui! <small> Basta dar uma olhada e ficar à vontade para explorar <br> __________________</small></h1>
        </div>
    </div>
    ...
    <div class="container marketing">
      ...
      <div class="container my-5">
        <h2 class="featurette-heading">Novidades em breve... <span class="text-muted">espere um pouco mais</span></h2>
